...
class FromToBlaza extends StatefulWidget {
  String? token;
  FromToBlaza({
    Key? key,
    this.token,
  ...
  @override
  State<FromToBlaza> createState() => _FromToBlazaState();
}

class _FromToBlazaState extends State<FromToBlaza> {
                ...
                getSelectedValue: (value) async {
                  ...
                  if (fromId == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (BuildContext context) => BlazaFloor(
                                  fromId: fromId,
                                  toId: toID,
                                  floor: floor,
                                  showRoute: true,
