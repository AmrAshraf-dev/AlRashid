...
class FromToGround extends StatefulWidget {
  String? token;
  FromToGround({
    Key? key,
    this.token,
  ...
  @override
  State<FromToGround> createState() => _FromToGroundState();
}

class _FromToGroundState extends State<FromToGround> {
                ...
                getSelectedValue: (value) async {
                  ...
                  if (fromId == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (BuildContext context) => GroundFloor(
                                  fromId: fromId,
                                  toId: toID,
                                  floor: floor,
                                  showRoute: true,
