...
class FromToFirst extends StatefulWidget {
  String? token;
  FromToFirst({
    Key? key,
    this.token,
  ...
  @override
  State<FromToFirst> createState() => _FromToFirstState();
}

class _FromToFirstState extends State<FromToFirst> {
                ...
                getSelectedValue: (value) async {
                  ...
                  if (fromId == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (BuildContext context) => FirstFloor(
                                  fromId: fromId,
                                  toId: toID,
                                  floor: floor,
                                  showRoute: true,
