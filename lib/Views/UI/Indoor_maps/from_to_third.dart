...
class FromToThird extends StatefulWidget {
  String? token;
  FromToThird({
    Key? key,
    this.token,
  ...
  @override
  State<FromToThird> createState() => _FromToThirdState();
}

class _FromToThirdState extends State<FromToThird> {
              ...
              child: TextFieldSearch(
                ...
                getSelectedValue: (value) async {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (BuildContext context) => ThirdFloor(
