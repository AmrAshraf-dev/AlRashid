...
import 'package:alrashid_mall_app/Map_collection_package/view/widgets/secondfloor_ui.dart';
import 'package:alrashid_mall_app/Views/UI/Indoor_maps/from_to_second.dart';
...
class _SecondFloorState extends State<SecondFloor> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) async {
      await _blocPositions.fetchAllPositionsData(context, 3);
    ...
    return Scaffold(
      ...
      body: ClipRRect(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (c) => FromToSecond()));
          },
          child: Container(
