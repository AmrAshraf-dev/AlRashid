...
import 'package:alrashid_mall_app/Map_collection_package/view/widgets/blaza_ui.dart';
...
class BlazaFloor extends StatefulWidget {
  final int? fromId;
  final int? toId;
  final int? floor;
  ...
  @override
  State<BlazaFloor> createState() => _BlazaFloorState();
}

class _BlazaFloorState extends State<BlazaFloor> {
  ...
  void initState() {
    ...
    print('floor in blaza :: ++>>${widget.floor}');
    ...
    WidgetsBinding.instance?.addPostFrameCallback(
      (_) async {
        await _blocPositions.fetchAllPositionsData(context, 0);
        // .whenComplete(() {
        //   setState(() {});
        // });
        // _blocRoutes.fetchAllRoutesData(
        //     context, widget.fromId ?? 0, widget.toId ?? 0);
    ...
    return Scaffold(
      ...
      body: ClipRRect(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (c) => FromToBlaza()));
          },
          child: Container(
