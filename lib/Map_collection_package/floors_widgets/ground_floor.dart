...
import 'package:alrashid_mall_app/Map_collection_package/view/widgets/ground_ui.dart';
...
import 'package:alrashid_mall_app/Views/UI/Indoor_maps/from_to_ground.dart';
...
class _GroundFloorState extends State<GroundFloor> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) async {
      await _blocPositions.fetchAllPositionsData(context, 1).whenComplete(() {
        setState(() {});
      });
    ...
    return Scaffold(
      ...
      body: ClipRRect(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (c) => FromToGround()));
          },
          child: Container(
                ...
                children: [
                  BlocBuilder<PoistionsCubit, PositionsState>(
                    builder: (context, state) {
                      print('loading::${_blocPositions.loading}');
