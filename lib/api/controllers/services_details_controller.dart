...
class ServicesDetailsController {
  static ServicesDetailsModel servicesDetailsModel = ServicesDetailsModel();
  static Future<bool> getServicesDetailsById(
  ...
  static Future<bool> _responseResult(
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      switch (model) {
        case "services":
          {
            servicesDetailsModel = servicesDetailsModelFromJson(response.body);
          }
