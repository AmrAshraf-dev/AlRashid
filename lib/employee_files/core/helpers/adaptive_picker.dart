...
class AdaptivePicker {
  ...
  static datePicker({required BuildContext context, required Function(DateTime? date) onConfirm, required String title, DateTime? initial, DateTime? minDate}) async {
    if (Platform.isIOS) {
  ...
  static _androidDatePicker(BuildContext context, Function(DateTime? date) onConfirm, {DateTime? initial, DateTime? minDate}) {
    showRoundedDatePicker(
        ...
        theme: ThemeData.light().copyWith(
          ...
          buttonTheme: const ButtonThemeData(textTheme: ButtonTextTheme.primary), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: MyColors.black),
        )).then(onConfirm);
  }
